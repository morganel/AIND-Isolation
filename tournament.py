...
def play_1round(agents, num_matches):
    """
    Play one match (i.e., a single match between each pair of opponents)
    """
    agent_1 = agents[-1]
    wins = 0.
    total = 0.
...
def main():
    ...
    for agentUT in test_agents:
        ...
        agents = random_agents + mm_agents + ab_agents + [agentUT] #random_agents + [agentUT]
